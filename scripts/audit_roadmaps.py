...
# validate_roadmaps.py hard-fails CI on this for open ("actionable") tasks only
# (conductor/t-107); this advisory finding covers `done` history too, so a
# legacy bad value stays visible in ROADMAP-AUDIT.md instead of going dark.
