...
Generated: `2026-07-14T14:03:28.225757+00:00`

This is a conservative structural audit. It reports suspicious state; it does not automatically change task status or remove human gates.

## Portfolio snapshot

- **40** roadmaps, **33** active projects, **492** tasks
- **116 ready**, **65 waiting**, **16 needs-human**, **1 claimed/review**, **283 done**
...
| 16 | `animation-manager` | active | software | 4 | 2 | 0 | 1 | 3 / 10 |
| 17 | `ecosystem-map` | active | software | 4 | 1 | 0 | 0 | 3 / 8 |
| 18 | `conductor` | active | software | 11 | 0 | 1 | 0 | 27 / 39 |
