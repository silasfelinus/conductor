...
Generated: `2026-07-19T14:13:34.531789+00:00`

This is a conservative structural audit. It reports suspicious state; it does not automatically change task status or remove human gates.

## Portfolio snapshot

- **40** roadmaps, **31** active projects, **621** tasks
- **60 ready**, **48 waiting**, **31 needs-human**, **1 claimed/review**, **470 done**
...
| 14 | `newsfeed` | active | software | 4 | 0 | 1 | 0 | 14 / 19 |
| 15 | `model-builder` | active | software | 3 | 0 | 0 | 0 | 28 / 31 |
| 16 | `animation-manager` | active | software | 2 | 2 | 0 | 1 | 6 / 11 |
