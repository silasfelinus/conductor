...
Generated: `2026-07-16T19:09:24.163183+00:00`

This is a conservative structural audit. It reports suspicious state; it does not automatically change task status or remove human gates.

## Portfolio snapshot

- **40** roadmaps, **32** active projects, **554** tasks
- **95 ready**, **54 waiting**, **24 needs-human**, **5 claimed/review**, **365 done**
- Findings: **1 errors**, **5 warnings**, **47 informational**
...
| 2 | `ai-art-academy` | active | software | 6 | 1 | 2 | 1 | 15 / 25 |
...
| 18 | `conductor` | active | software | 10 | 0 | 2 | 3 | 40 / 55 |
...
| 25 | `alexa-integration` | active | software | 1 | 1 | 0 | 0 | 14 / 16 |
...
| 34 | `dream-cycle` | active | software | 1 | 2 | 0 | 1 | 10 / 14 |
...
- **WAITING_WITH_SATISFIED_DEPS** — `alexa-integration` / `t-010`: All dependencies are satisfied; resolver should promote this task to ready.
