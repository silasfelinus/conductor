...
- `music-mentor` — icon, card, hero → `projects/images/music-mentor-{type}.webp` in `silasfelinus/conductor`
...
## davinci (added 2026-07-04)
- `davinci-icon.webp` (256×256): flat minimal app icon for Da Vinci, a life-simulation story game — an elegant hand sketching a spiral of life moments, bold clean vector shapes, square composition, no text
- `davinci-card.webp` (512×768): polished portrait illustration for Da Vinci — a figure at a crossroads of many branching illustrated life paths, renaissance-sketch-meets-modern-game style, rich Kind Robots visual style, no text, 2:3 portrait
- `davinci-hero.webp` (1280×720): wide cinematic hero image for Da Vinci — a sweeping timeline of one life from cradle to legacy rendered as a renaissance fresco with game-UI accents, expressive atmosphere, no text, 16:9

## interface-vision (added 2026-08-01)
- `interface-vision-icon.webp` (256×256): premium app icon for Interface Vision, a single luminous rectangular frame that holds one calm nested panel in perfect alignment while three tangled crooked frames dissolve into light at the edges, clarity emerging from clutter, crisp readable silhouette at small sizes, polished product app-icon composition, square, no text, no logo, no watermark, no collage
- `interface-vision-card.webp` (512×768): portrait key art for Interface Vision, a theater stage viewed from the wings where a warm spotlight falls on one clean glowing interface panel standing center stage, a friendly robot narrator beside it gesturing toward a large framed illustration, discarded crooked window-frames stacked in the shadowed backstage clutter behind, stagecraft meets product design, cinematic warm-with-an-edge lighting, 2:3 portrait, no readable text, no logo, no watermark, no collage
- `interface-vision-hero.webp` (1280×720): wide cinematic hero for Interface Vision, a grand proscenium theater where the stage IS a single beautifully composed interface — one header line, one generous image plate, one calm scrolling panel — lit from above, while a diverse audience of humans, robots, animal-like beings and fantasy creatures watches from warm-lit seats; in the darkened orchestra pit below, a tangle of duplicated headers and mismatched nested frames sinks quietly out of view, premium design-studio illustration, confident visual hierarchy, 16:9 landscape, no readable text, no logo, no watermark, no collage

## text-generation (added 2026-08-16)
...
**Project assets:**
- `tzaddik-gallery-icon.webp` — Premium app icon for Tzaddik Gallery, thirty-six tiny luminous portrait tiles orbiting a simple open globe with one warm empty place inviting the next person, playful civic-pop-culture energy, crisp readable silhouette, square composition, no readable text, no logo, no watermark, no collage.
- `tzaddik-gallery-card.webp` — Portrait key art for Tzaddik Gallery, a colorful museum-style wall of varied human portraits from many regions and professions, visitors leaving small vote tokens beneath candidate frames while source cards and footnotes sit visibly beside them, warm slightly absurd educational gallery energy, 2:3 portrait composition, no readable text, no logo, no watermark, no collage.
- `tzaddik-gallery-hero.webp` — Wide cinematic hero for Tzaddik Gallery, a global hall of thirty-six illuminated portrait niches wrapping around a central world map, scientists, artists, organizers, rescuers, teachers, conservationists, and public servants represented through varied visual cues while visitors browse sourced biography plaques and debate candidates, joyous pop-culture museum aesthetic, 16:9 landscape composition, no readable text, no logo, no watermark, no collage.

### tzaddik-gallery — interface splash

- `tzaddik-gallery-splash.webp` (1920×1080) — Stylish wide interface background for Tzaddik Gallery: an elegant contemporary hall of portrait frames curving around the edges of a luminous world-at-night, visual hints of teachers, rescuers, scientists, artists, organizers, conservationists, cooks, doctors, and builders represented through objects and environments rather than saintly symbolism; central and lower-middle areas kept visually calm for a large portrait and readable interface panels, richer detail toward the perimeter, warm museum light mixed with subtle global night colors, sophisticated pop-culture editorial energy, humane and playful rather than religious, no halos, no clerical costume shorthand, no readable text, no logos, no watermark, no collage, 16:9 landscape composition.
