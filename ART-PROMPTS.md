...
## da-vinci (added 2026-07-04)
- `da-vinci-icon.webp` (256×256): flat minimal app icon for Da Vinci, a life-simulation story game — an elegant hand sketching a spiral of life moments, bold clean vector shapes, square composition, no text
- `da-vinci-card.webp` (512×768): polished portrait illustration for Da Vinci — a figure at a crossroads of many branching illustrated life paths, renaissance-sketch-meets-modern-game style, rich Kind Robots visual style, no text, 2:3 portrait
- `da-vinci-hero.webp` (1280×720): wide cinematic hero image for Da Vinci — a sweeping timeline of one life from cradle to legacy rendered as a renaissance fresco with game-UI accents, expressive atmosphere, no text, 16:9
