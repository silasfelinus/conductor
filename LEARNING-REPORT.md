...
Generated: 2026-07-19T14:18:26Z

Aggregated from the append-only `LEARNING.yaml` ledger. The Reviewer consults this before creating kaizen tasks — systematic weaknesses beat generic improvements (AGENTS.md § "Learning ledger").

## Overall

- Closed tasks recorded: **294**
- Outcomes: blocked: 12, done: 282
- Success rate: **96%**
...
- 2026-07-19 `model-builder/t-025` — Extracting the shared routing/merge logic (resolveArtGenerationRoute, mergeCurrentArtOverrides) before forking a synchronous flow into sync+async variants keeps the two paths from drifting on server selection, hosted-engine fallback, and form-overrides -- worth doing as a first step whenever a task asks to add a queue-based sibling to an existing synchronous action, rather than duplicating the body and hoping to keep both in sync by hand.
...
---
_Auto-generated by `scripts/build_learning_summary.py` at 2026-07-19T14:18:26Z_
