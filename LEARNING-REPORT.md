...
Generated: 2026-07-12T20:45:16Z

Aggregated from the append-only `LEARNING.yaml` ledger. The Reviewer consults this before creating kaizen tasks — systematic weaknesses beat generic improvements (AGENTS.md § "Learning ledger").

## Overall

- Closed tasks recorded: **15**
- Outcomes: done: 15
- Success rate: **100%**
...
- 2026-07-12 `model-builder/t-021` — Once a resource is durable, the cheapest high-value follow-up is a history/list surface — the list endpoint already existed, so the run-history panel was pure front-end with zero new API. kind_robots PR #189.

---
_Auto-generated by `scripts/build_learning_summary.py` at 2026-07-12T20:45:16Z_
