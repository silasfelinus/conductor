...
if ( ! function_exists( 'lingam_get_defaults' ) ) {
	/**
	 * Set default options
	 *
	 */
	function lingam_get_defaults() {
		$lingam_defaults = array(
			'hide_title' => '',
			'hide_tagline' => true,
			'top_bar_width' => 'full',
		...
		return apply_filters( 'lingam_option_defaults', $lingam_defaults );
	}
}

if ( ! function_exists( 'lingam_get_color_defaults' ) ) {
	/**
	 * Set default options
	 */
	function lingam_get_color_defaults() {
		$lingam_color_defaults = array(
			'top_bar_background_color' => '#ffff01',
			'top_bar_text_color' => '#333333',
			'top_bar_link_color' => '#ff7300',
			'top_bar_link_color_hover' => '#333333',
			'header_background_color' => '#e50977',
			'header_text_color' => '#ffff01',
			'header_link_color' => '#ffff01',
			'header_link_hover_color' => '#ffff01',
			'site_title_color' => '#ffff01',
			'site_tagline_color' => '#ffff01',
			'navigation_background_color' => '#e50977',
			'navigation_text_color' => '#ffff01',
			'navigation_background_hover_color' => '',
			'navigation_text_hover_color' => '#99d501',
			'navigation_background_current_color' => '',
			'navigation_text_current_color' => '',
			'subnavigation_background_color' => '#333333',
			'subnavigation_text_color' => '#ffff01',
			'subnavigation_background_hover_color' => '',
			'subnavigation_text_hover_color' => '#99d501',
			'subnavigation_background_current_color' => '',
			'subnavigation_text_current_color' => '',
			'fixed_side_content_background_color' => '#ffff01',
			'fixed_side_content_text_color' => '#333333',
			'fixed_side_content_link_color' => '#333333',
			'fixed_side_content_link_hover_color' => '#ff7300',
			'content_background_color' => '',
			'content_text_color' => '',
			'content_link_color' => '',
			'content_link_hover_color' => '',
			'content_title_color' => '',
			'blog_header_bg_color' => '#ff7300',
			'blog_header_title_color' => '#e50977',
			'blog_header_text_color' => '#ffff01',
			'blog_header_button' => '#e50977',
			'blog_header_button_bg' => '#ffff01',
			'blog_header_button_hover' => '#ffff01',
			'blog_header_button_hover_bg' => '#e50977',
			...
			'h5_color' => '',
			'h6_color' => '',
			'sidebar_widget_background_color' => '#ff7300',
			'sidebar_widget_text_color' => '#ffffff',
			'sidebar_widget_link_color' => '#ffff01',
			'sidebar_widget_link_hover_color' => '#ffffff',
			'sidebar_widget_title_color' => '#ffff01',
			'footer_widget_background_color' => '#e50977',
			'footer_widget_text_color' => '#ffff01',
			'footer_widget_link_color' => '#ffff01',
			'footer_widget_link_hover_color' => '#ffff01',
			'footer_widget_title_color' => '#ffff01',
			'footer_background_color' => '#ffff01',
			'footer_text_color' => '#333333',
			'footer_link_color' => '#ff7300',
			...
			'form_button_background_color' => '#ffff01',
			'form_button_background_color_hover' => '#e50977',
			'form_button_text_color' => '#e50977',
			'form_button_text_color_hover' => '#ffff01',
			'back_to_top_background_color' => 'rgba(229,9,119,0.7)',
			'back_to_top_background_color_hover' => '#e50977',
			'back_to_top_text_color' => '#ffff01',
			'back_to_top_text_color_hover' => '#ffff01',
		);

		return apply_filters( 'lingam_color_option_defaults', $lingam_color_defaults );
	}
}
...
if ( ! function_exists( 'lingam_get_default_fonts' ) ) {
	 ...
	 */
	function lingam_get_default_fonts( $filter = true ) {
		$lingam_font_defaults = array(
			'font_body' => 'Aladin',
			'font_body_category' => '',
			...
			'font_blog_header_title' => 'Bangers',
		...
		if ( $filter ) {
			return apply_filters( 'lingam_font_option_defaults', $lingam_font_defaults );
		}

		return $lingam_font_defaults;
	}
}

if ( ! function_exists( 'lingam_spacing_get_defaults' ) ) {
	/**
	 ...
	 * @return array Option defaults.
	 */
	function lingam_spacing_get_defaults( $filter = true ) {
		$lingam_spacing_defaults = array(
			'top_bar_top' => '0',
			'top_bar_right' => '40',
			'top_bar_bottom' => '0',
			'top_bar_left' => '40',
		...
		if ( $filter ) {
			return apply_filters( 'lingam_spacing_option_defaults', $lingam_spacing_defaults );
		}

		return $lingam_spacing_defaults;
	}
}

if ( ! function_exists( 'lingam_get_default_color_palettes' ) ) {
	/**
	 * Set up our colors for the color picker palettes and filter them so you can change them.
	 *
	 */
	function lingam_get_default_color_palettes() {
		$palettes = array(
			'#ffff01',
			'#e50977',
			'#018eff',
		...
		return apply_filters( 'lingam_default_color_palettes', $palettes );
	}
}

if ( ! function_exists( 'lingam_typography_default_fonts' ) ) {
	/**
	 * Set the default system fonts.
	 *
	 */
	function lingam_typography_default_fonts() {
		$fonts = array(
			'inherit',
			'System Stack',
		...
		return apply_filters( 'lingam_typography_default_fonts', $fonts );
	}
}

define( 'LINGAM_DEFAULT_FONTS' , '//fonts.googleapis.com/css?family=Aladin:regular|Bangers:regular|Monofett:regular' );
