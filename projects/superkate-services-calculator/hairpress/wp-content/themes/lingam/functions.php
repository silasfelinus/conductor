...
define( 'LINGAM_VERSION', '1.2.0' );

if ( ! function_exists( 'lingam_setup' ) ) {
	add_action( 'after_setup_theme', 'lingam_setup' );
	/**
	 * Sets up theme defaults and registers support for various WordPress features.
	 *
	 */
	function lingam_setup() {
		// Make theme available for translation.
		load_theme_textdomain( 'lingam' );
		...
		register_nav_menus( array(
			'primary' => __( 'Primary Menu', 'lingam' ),
		) );

		/**
		 * Set the content width to something large
		 * We set a more accurate width in lingam_smart_content_width()
		 */
...
define('LINGAM_THEME_URL','https://wpkoi.com/lingam-wpkoi-wordpress-theme/');
define('LINGAM_WPKOI_AUTHOR_URL','https://wpkoi.com/');
define('LINGAM_WPKOI_SOCIAL_URL','https://www.facebook.com/wpkoithemes/');
define('LINGAM_WORDPRESS_REVIEW','https://wordpress.org/support/theme/lingam/reviews/?filter=5');
define('LINGAM_DOCUMENTATION', 'https://wpkoi.com/docs/');
define('LINGAM_FONT_AWESOME_LINK','https://wpkoi.com/docs/custom-icons/');