...
- **Postmistress Vesper** — a luna moth in a mail-carrier's cap; remembers every
  letter she's ever carried and exactly one she couldn't deliver.
- **Smudge** — an apprentice moth, clumsy, keeps eating the corners of envelopes;
  has perfect recall of feelings but not names.
- **The Dead-Letter Clerk** — a shadowy, kindly figure who files the letters whose
  recipients are gone; insists his department is the most hopeful one.

## Rewards (3-6)
- **Moth-Dust Stamp** (COMMON) — makes any message 10% braver.
- **Return to Sender** (UNCOMMON) — a kindness you did comes back around.
- **The Unsent Letter** (RARE) — blank until you know what it needed to say.
- **Vesper's Last Route** (LEGENDARY) — one delivery, anywhere, any-when.
