...
export const seedData: SeedData = {
  customers: [
    {
      ...
      phone: '555-0101',
      status: 'active',
      notes: 'Dummy customer for local development only.',
      createdAt: now,
      updatedAt: now,
    },
    {
      id: 'cus-chen',
      displayName: 'Theo Chen',
  ...
  properties: [
    {
      id: 'prop-rivera-home',
      customerId: 'cus-rivera',
      label: 'Home yard',
      streetAddress: '101 Example Lane',
      city: 'Eureka',
      state: 'CA',
      postalCode: '95501',
      yardSize: 'medium',
      access: 'gate-code',
      accessNotes: 'Gate code stored as dummy text only.',
      serviceNotes: 'Check side yard behind garage.',
      isPrimary: true,
      createdAt: now,
      updatedAt: now,
    },
  ...
  servicePlans: [
    {
      ...
      currency: 'USD',
      startsOn: '2026-07-01',
      notes: 'Dummy weekly plan for schema testing.',
      createdAt: now,
      updatedAt: now,
    },
  ],
  visits: [
    {
      id: 'visit-rivera-2026-07-07',
      servicePlanId: 'plan-rivera-weekly',
      customerId: 'cus-rivera',
      propertyId: 'prop-rivera-home',
      scheduledFor: '2026-07-07T16:00:00Z',
      status: 'scheduled',
      createdAt: now,
      updatedAt: now,
    },
  ...
  draftInvoices: [
    {
      ...
      lineItems: [
        {
          id: 'line-rivera-visit-2026-07-07',
          invoiceId: 'inv-rivera-july-draft',
          visitId: 'visit-rivera-2026-07-07',
          description: 'Weekly yard cleanup — dummy line item',
          quantity: 1,
          unitPriceCents: 2500,
          totalCents: 2500,
        },
