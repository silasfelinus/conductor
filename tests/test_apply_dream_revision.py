...
def proposal() -> dict:
    ...
    return {
        ...
        "characters": [
            {
                "name": "Tessa Nunes",
                "role_drive": "relight the far reef beacon before the returning sea cuts off the village",
                "carries": "a folding prism spear built from salvaged survey technology",
                "complication": "her tide-light transformation lasts ninety seconds and attracts every deep-water hunter nearby",
        ...
        "rewards": [
            {
                ...
                "reward_type": "ITEM",
                "rarity": "RARE",
                "grants": "stores one burst of moonlight powerful enough to relight a dead beacon",
                "best_used_when": "the coast has gone completely dark",
            ...
            },
            {
                ...
                "reward_type": "SKILL",
                "rarity": "UNCOMMON",
                "grants": "reads hidden currents through pressure changes underfoot",
                "best_used_when": "crossing exposed or flooded terrain with no visible trail",
                "catch": "living movement and rushing water feel exactly alike",
